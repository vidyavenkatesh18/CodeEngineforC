    ...
    <div class="container">
        <div class="row">
            ...
            function calculate()
            {
                ...
                result.innerHTML = "Simple Interest is " + (p*n*r/100);
            }
        </script>
    </head>
       ...
       Enter Principal Amount : &nbsp<input id="p"><br/><br>
       Enter Rate of Interest : &nbsp&nbsp&nbsp&nbsp<input id="r"><br/><br>
       Enter Period of Time : &nbsp&nbsp&nbsp&nbsp&nbsp<input id="n"><br/>
        <p id="result"></p>
        <button onclick="calculate()">Click to Calculate</button><br><br>
</center></div>
    </div>
    </div>
    </div>
