...
{
 var html = "<h4>Prime Numbers within the entered range are</h4>";
...
<form name="numbers">
Beginning Number <input type="number" name="firstNum" /><br><br> &nbsp &nbsp &nbsp &nbsp &nbsp 
End Number <input type="number" name="secondNum" /><br>
<div id="output_content"> <br>
