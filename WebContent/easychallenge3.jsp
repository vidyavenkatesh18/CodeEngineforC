  ...
  <div class="container">
   ...
   <table class="table table-bordered table-hover">
    ...
    <tbody>
      <tr>
        <td>3</td>
        <td>Program to find the sum of two numbers</td>
        <td>5<br>10</td>
        <td>15</td>
      </tr>
    </tbody>
...
<div id="collapse1" style="display:none">
				<p>Read the Value of A and B.<br>
                    SUM = A+B.<br>
                    Display SUM.<br>
                         Stop.</p>
			</div>
...
<div id="answerBlock">
<form action="validatechallenge3.jsp" method="post"> 
<div class="login-form">
<div class="control-group">
<input type="text" class="login-field" align="left" value="3" placeholder="challengeid"  name="challengeid" required/>
</div>
<br>
 <div class="login-form">
 <div class="control-group">
