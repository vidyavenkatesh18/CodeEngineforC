  ...
  <div class="container">
   ...
   <table class="table table-bordered table-hover">
    ...
    <tbody>
      <tr>
        <td>10</td>
        <td width="30%">Program to Reverse an integer.</td>
        <td width="30%">Eg: Enter an Integer 123<br></td>
        <td width="30%">Eg : 321 </td>
         </tr>
    </tbody>
  </table>
 </div>
...
<div id="collapse1" style="display:none">
				<p>Get the least significant digit(right most digit) of the number. <br>
                   remainder = n%10;<br>
                   Append it at the end of reverse number.<br>
                   reversedNumber = (reversedNumber * 10) + remainder;<br> </p>
			</div>
            ...
            <div id="collapse2" style="display:none">
				<p>Remove right most digit from number.<br>
                  n = /10;<br>
                  Repeat this process till number is greater than zero.</p>
                    
			</div>
<body onload="">
<h1>Countdown to solve the Challenge : <span id="secondsLeft"></span></h1>
<div id="answerBlock">
<form action="validatechallenge10.jsp" method="post"> 
<div class="login-form">
<div class="control-group">
<input type="text" class="login-field" align="left" value="10" placeholder="challengeid"  name="challengeid" required/>
</div>
<br>
 <div class="login-form">
 <div class="control-group">
