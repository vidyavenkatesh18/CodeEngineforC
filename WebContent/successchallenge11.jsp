...
&nbsp; &nbsp;<p>Enter an sentence or word  <input type="text" id="text" placeholder=""/> </p>
<p> Case changed sentence is  <input type="text" id="result" placeholder=""/> </p><br>
 &nbsp; &nbsp;  &nbsp;<input type="button" style="width:310px;padding:6px" value="clickme to convert to Lowercase" onClick="convertToLowercase();"/> 
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <input type="button" style="width:310px;padding:6px" value="clickme to convert to Uppercase" onClick="convertToUppercase();"/>
<br/><br/>  
    </center>
    </div>
    </div>
