  ...
  <div class="container">
   ...
   <table class="table table-bordered table-hover">
    ...
    <tbody>
      <tr>
        <td>12</td>
        <td width="30%">Program to find the Square root of any number without using predefined functions in math.h</td>
        <td width="30%">Eg:Enter Number: 4<br></td>
        <td width="30%">Eg : The square root is: 2 </td>
         </tr>
    </tbody>
  </table>
 </div>
...
<div id="answerBlock">
<form action="validatechallenge12.jsp" method="post"> 
<div class="login-form">
<div class="control-group">
<input type="text" class="login-field" align="left" value="12" placeholder="challengeid"  name="challengeid" required/>
</div>
<br>
 <div class="login-form">
 <div class="control-group">
