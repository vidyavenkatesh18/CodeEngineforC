...
if(temp==b)
{
 text="Entered value is a Palindrome integer";
}
else
{
text="Entered value is Not Palindrome integer";
}
document.getElementById("demo").innerHTML = text;
}
</script>
<h2 class="post-title" id="two">Your Output is </h2>
<p> Enter an integer : <input id="no_input" required/> </p>
<button onclick="palin()">Click me to know if entered integer is palindrome or not</button>
<p id="demo"></p>
<br>
<br>
<br>
