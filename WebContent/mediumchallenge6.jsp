  ...
  <div class="container">
   ...
   <table class="table table-bordered table-hover">
    ...
    <tbody>
      <tr>
        <td>6</td>
        <td width="30%">program to find leap year using if statement.</td>
        <td width="30%">Eg : Enter desired year 1997 </td>
        <td width="30%">Eg : The year 1997 is not a leap year </td>
         </tr>
    </tbody>
  </table>
 </div>
...
<div id="collapse1" style="display:none">
				<p>IF year MODULER 400 IS 0 and <br>
                  IF year MODULER 4 IS 0 THEN leap_year </p>
			</div>
            ...
            <div id="collapse2" style="display:none">
				<p>ELSE IF year MODULER 100 IS 0 THEN not_leap_year</p>
                    
			</div>
<body onload="">
<h1>Countdown to solve the Challenge : <span id="secondsLeft"></span></h1>
<div id="answerBlock">
<form action="validatechallenge6.jsp" method="post"> 
<div class="login-form">
<div class="control-group">

<input type="text" class="login-field" align="left" value="6" placeholder="challengeid"  name="challengeid" required/>
</div>
<br>
 <div class="login-form">
 <div class="control-group">
