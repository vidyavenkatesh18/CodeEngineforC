  ...
  <div class="container">
   ...
   <table class="table table-bordered table-hover">
    ...
    <tbody>
      <tr>
        <td>11</td>
        <td width="30%">Program to convert Uppercase to Lowercase and viceversa without using string function.</td>
        <td width="30%">Eg: Enter an sentence or word : HOW ARE YOU <br></td>
        <td width="30%">Eg : Case changed sentence is : how are you </td>
         </tr>
    </tbody>
  </table>
 </div>
...
<div id="collapse1" style="display:none">
				<p>Initialize integer as count, ch, i <br>
				   and as character sentence[100] </p>
			</div>
            ...
            <div id="collapse3" style="display:none">
             ...
             ch = islower(sentence[i])? toupper(sentence[i]) : tolower(sentence[i]);<br>
             </p>
...
<form action="validatechallenge11.jsp" method="post"> 
<div class="login-form">
<div class="control-group">
<input type="text" class="login-field" align="left" value="11" placeholder="challengeid"  name="challengeid" required/>
</div>
<br>
 <div class="login-form">
 <div class="control-group">
