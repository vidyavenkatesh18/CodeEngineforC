  ...
  <div class="container">
   ...
   <table class="table table-bordered table-hover">
    ...
    <tbody>
      <tr>
        <td>9</td>
        <td width="30%">program to Display prime numbers between two intervals using nested for loop and if...else statement.</td>
        <td width="30%">Eg:Beginning Number 1 <br>                                                                                                                                                      
                             End Number 10                                                                                                                                                              
                              </td>
        <td width="30%">Eg : Prime Numbers within the entered range are 1 2 3 5 7 </td>
         </tr>
    </tbody>
  </table>
 </div>
...
<div id="collapse1" style="display:none">
				<p>A natural number greater than one which has not any <br>
				other divisors except 1 and itself is called prime number.<br> 
				In other word we can say which has only two divisors 1 and <br>
				number itself. <br>
                 Note: 2 is only even prime number.</p>
			</div>
            ...
            <div id="collapse2" style="display:none">
				<p>take a loop and divide number from 2 to number/2. <br>
				If the number is not divisible by any of the numbers <br>
				then we will print it as prime number.</p>
                    
			</div>
<body onload="">
<h1>Countdown to solve the Challenge : <span id="secondsLeft"></span></h1>
<div id="answerBlock">
<form action="validatechallenge9.jsp" method="post"> 
<div class="login-form">
<div class="control-group">
<input type="text" class="login-field" align="left" value="9" placeholder="challengeid"  name="challengeid" required/>
</div>
<br>
 <div class="login-form">
 <div class="control-group">
