...
<p>Enter desired year </p>
<input type="text" id="userInput" size="4" maxlength="4" autofocus>
<p id="result"></p>
<input type="submit" value="Check" title="Click here to check for leap year." onclick="count_words()" />     
<input type="submit" value="Clear" title="Click here to clear the text box." onclick="clear_textbox()" /><br> <br>
