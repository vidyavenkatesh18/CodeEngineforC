...
<p>Enter a number to calculate its factorial <input id="num"> </p>
<p>Factorial of entered number is <input id="answer"></p>
<button onclick="show()">Click me to know your input answer</button><br>
<br>
    <br>
   <br>
  <center>
