  ...
  <div class="container">
   ...
   <table class="table table-bordered table-hover">
    ...
    <tbody>
      <tr>
        <td>13</td>
        <td width="30%">Program to find Sum and Average of Three Real Numbers.</td>
        <td width="30%">Eg : Enter three numbers 2 <br> 2 <br> 2<br></td>
        <td width="30%">Eg : The sum is:6 <br>  The average is:2  </td>
         </tr>
    </tbody>
  </table>
 </div>
...
<div id="collapse1" style="display:none">
				<p>Initialize x,y,z,sum,avg as float </p>
			</div>
...
<form action="validatechallenge13.jsp" method="post"> 
<div class="login-form">
<div class="control-group">
<input type="text" class="login-field" align="left" value="13" placeholder="challengeid"  name="challengeid" required/>
</div>
<br>
 <div class="login-form">
 <div class="control-group">
