  ...
  <div class="container">
   ...
   <table class="table table-bordered table-hover">
    ...
    <tbody>
      <tr>
        <td>1</td>
        <td>Program to print Hello World</td>
        <td>Hello World</td>
      </tr>
    </tbody>
  </table>
...
<div id="collapse1" style="display:none">
				<p>Add a print statement [ printf("Hello World"); ]</p>
			</div>
<body onload="">
<h1>Countdown to solve the Challenge : <span id="secondsLeft"></span></h1>
<div id="answerBlock">
<form action="validatechallenge1.jsp" method="post"> 
<div class="login-form">
<div class="control-group">

<input type="text" class="login-field" align="left" value="1" placeholder="challengeid"  name="challengeid" required/>
</div>
<br>
