  ...
  <div class="container">
   ...
   <table class="table table-bordered table-hover">
    ...
    <tbody>
      <tr>
        <td>14</td>
        <td width="30%">program to find the simple interest given principle amount,rate of interest and period of time.</td>
        <td width="30%">Eg : Enter Principal Amount :2000 <br> Enter Rate of Interest :5 <br> Enter Period of Time : 2 </td>
        <td width="30%">Eg : Simple Interest is 200 </td>
         </tr>
    </tbody>
  </table>
 </div>
...
<button type="button" id="Hint1" href="#collapse1" class="nav-toggle"  align="left" onclick="this.disabled=true;document.getElementById('up7913').disabled=false;" type="submit" class="negative" name="down7913" id="down7913"">Hint 1</button>
<div id="collapse1" style="display:none">
				<p>Input principle amount in some variable say amount</p>
			</div>
			
			<button type="button" id="Hint2" href="#collapse2" class="nav-toggle" align="right" onclick="this.disabled=true;document.getElementById('up7913').disabled=false;" type="submit" class="negative" name="down7913" id="down7913"">Hint 2</button>
            <div id="collapse2" style="display:none">
				<p>Input time in some variable say time.<br>
                   Input rate in some variable say rate.</p>
                    
			</div>
			<button type="button" id="Hint3" href="#collapse3" class="nav-toggle" align="right" onclick="this.disabled=true;document.getElementById('up7913').disabled=false;" type="submit" class="negative" name="down7913" id="down7913"">Hint 3</button>
            <div id="collapse3" style="display:none">
				<p>Now,apply the formula to calculate simple interest <br>
				i.e. Si = (principle * time * rate) / 100 <br>
...
<div id="answerBlock">
<form action="validatechallenge14.jsp" method="post"> 
<div class="login-form">
<div class="control-group">
<input type="text" class="login-field" align="left" value="14" placeholder="challengeid"  name="challengeid" required/>
</div>
<br>
 <div class="login-form">
 <div class="control-group">
