...
if(num1>num2)   
  {   
  text= +num1+ " is greater.";  
  }     
else  
  if(num2>num1)   
  {  
	  text= +num2+ " is greater."; 
  }
else  
  {  
   text="Entered values are equal.";  
  } 
...
<p>Enter two integers </p>
       <input type="number" ng-model="myText" min="0" id="num1"> <br><br>
  <input type="number" ng-model="myText" min="0" id="num2"> <br><br>
  <input type="button" name="Submit" value="Click here to know your answer" onclick="myFunction()">
<p id="demo"></p>
