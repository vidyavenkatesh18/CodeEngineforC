  ...
  <div class="container">
   ...
   <table class="table table-bordered table-hover">
    ...
    <tbody>
      <tr>
        <td>5</td>
        <td>Program to check greatest of two numbers or equal using if statement.</td>
        <td>Eg : Enter a number :4  6 </td>
        <td>Eg : 6 is greater</td>
      </tr>
    </tbody>
  </table>
 </div>
...
<script>
     ...
     <div id="collapse1" style="display:none">
				<p>
                 If num1=num2<br>
                 Display Entered values are equal<br>
                 If num1>num2<br>
                 Display num1 is greater.<br>
                 Else<br>
...
<form action="validatechallenge5.jsp" method="post"> 
<div class="login-form">
<div class="control-group">
<input type="text" class="login-field" align="left" value="5" placeholder="challengeid"  name="challengeid" required/>
</div>
<br>
 <div class="login-form">
 <div class="control-group">
