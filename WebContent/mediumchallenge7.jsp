  ...
  <div class="container">
   ...
   <table class="table table-bordered table-hover">
    ...
    <tbody>
      <tr>
        <td>7</td>
        <td width="30%">Program to check if the Entered number is Positive or Negative using nested if elseif..else</td>
        <td width="30%">Eg : Enter a Number:345 </td>
        <td width="30%">Eg : 345 is a positive number. </td>
         </tr>
    </tbody>
  </table>
 </div>
...
<div id="collapse1" style="display:none">
				<p>If number is less than 0<br>
                  display number is a Negative Number.</p>
			</div>
            ...
            <div id="collapse2" style="display:none">
				<p>If number is greater than 0 <br> display number is a Positive Number else You Entered zero.</p>
...
<form action="validatechallenge7.jsp" method="post"> 
<div class="login-form">
<div class="control-group">
<input type="text" class="login-field" align="left" value="7" placeholder="challengeid"  name="challengeid" required/>
</div>
<br>
 <div class="login-form">
 <div class="control-group">
