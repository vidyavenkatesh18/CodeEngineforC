  ...
  <div class="container">
   ...
   <table class="table table-bordered table-hover">
    ...
    <tbody>
      <tr>
        <td>8</td>
        <td width="30%">Program to check if the Entered number is Even or Odd using Conditional Operator.</td>
        <td width="30%">Eg : Enter a Number 6  </td>
        <td width="30%">Eg : The number is even </td>
         </tr>
    </tbody>
  </table>
 </div>
...
<div id="collapse1" style="display:none">
				<p>The conditional operator works as follows: The first operand is implicitly converted to bool.<br>
				It is evaluated and all side effects are completed before continuing. </p>
			</div>
...
<div id="answerBlock">
<form action="validatechallenge8.jsp" method="post"> 
<div class="login-form">
<div class="control-group">
<input type="text" class="login-field" align="left" value="8" placeholder="challengeid"  name="challengeid" required/>
</div>
<br>
 <div class="login-form">
 <div class="control-group">
