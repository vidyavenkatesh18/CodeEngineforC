  ...
  <div class="container">
   ...
   <table class="table table-bordered table-hover">
    ...
    <tbody>
      <tr>
        <td>4</td>
        <td>Program to check if the given number is Palindrome or not</td>
        <td>Eg : Enter a number : 121</td>
        <td>Eg : The Number 121 is Palindrome.</td>
      </tr>
    </tbody>
  </table>
 </div>
...
<div id="collapse1" style="display:none">
				<p>Read number from user. Store it in some variable say <i>originalInteger</i> <br>
                  Find reverse of the number. Store it in some variable say <i>reversedInteger</i><br>
            Compare original number with reversed number. If both are same then the number is palindrome otherwise not.</p>
			</div>
<body onload="">
<h1>Countdown to solve the Challenge : <span id="secondsLeft"></span></h1>
<div id="answerBlock">
<form action="validatechallenge4.jsp" method="post"> 
<div class="login-form">
<div class="control-group">
<input type="text" class="login-field" align="left" value="4" placeholder="challengeid"  name="challengeid" required/>
</div>
<br>
 <div class="login-form">
 <div class="control-group">
