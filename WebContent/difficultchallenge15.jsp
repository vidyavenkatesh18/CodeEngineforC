  ...
  <div class="container">
   ...
   <table class="table table-bordered table-hover">
    ...
    <tbody>
      <tr>
        <td>15</td>
        <td width="30%">Program to Swap two numbers using pointers.</td>
        <td width="30%">Eg : Enter the value of x : 20 <br> Enter the value of y : 40 </td>
        <td width="30%">Eg : After Swapping <br> value of x: 40 <br> value of y: 20</td>
         </tr>
    </tbody>
  </table>
 </div>
...
<div id="collapse1" style="display:none">
            ...
            <div id="collapse2" style="display:none">
				<p>inter change the values<br> temp=b <br> b=a <br>a=temp </p>
...
<div id="answerBlock">
<form action="validatechallenge15.jsp" method="post"> 
<div class="login-form">
<div class="control-group">
<input type="text" class="login-field" align="left" value="15" placeholder="challengeid"  name="challengeid" required/>
</div>
<br>
 <div class="login-form">
 <div class="control-group">
