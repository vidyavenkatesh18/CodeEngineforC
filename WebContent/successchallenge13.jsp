    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                sum+=Number(ent[i].value)*Math.pow(10,r)//fixes the CPU binary rounding possible error 
                } 
                f.sumBox.value = (sum/Math.pow(10,r)).toFixed(r);//rounds to r decimals 
                f.averageBox.value = ((sum/Math.pow(10,r))/ent.length).toFixed(r);//rounds to r decimals
                } 
               </script> 
...
<div id="entries"> 
<input type="text" name="num1Box" size="5"><br><br>
<input type="text" name="num2Box" size="5"><br><br>
<input type="text" name="num3Box" size="5"><br><br> 
</div> 
The sum is: <input type="text" style="width:100px;padding:6px" name="sumBox" size="6"> &nbsp
The average is: <input type="text" style="width:100px;padding:6px" name="averageBox" size="6"><br><br>
<input type="button" value="Click to Calculate Sum and Average" style="width:310px;padding:6px" onclick ="calculate(this.form)"> <br><br>
</form>
