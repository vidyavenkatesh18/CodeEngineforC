...
<!-- Navigation -->
 ...
 <center>
<form name=form1>
&nbsp; &nbsp; &nbsp; &nbsp;Enter Number: <input type="text" name="input1" size=10> <br><br>
The square root is: <input type="text" name="answer" size=20> <br><br>
<input type="button" value="Click to know the squareroot" onClick='doMath()'> <br>
<br>
